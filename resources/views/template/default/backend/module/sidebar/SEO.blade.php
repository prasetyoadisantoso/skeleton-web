...
<li class="active py-1 shadow-sm">
    <a href="#seo-dropdown-menu" data-bs-toggle="collapse" aria-expanded="false"
        ...
        <div class="d-flex align-items-center main-list" id="rotation-seo">
            <span class="flex-grow-1 font-md"><i class="fa-brands fa-searchengin me-3"></i>{{$sidebar['seo']}}</span>
    ...
    <ul class="collapse list-unstyled mx-5 mt-3" id="seo-dropdown-menu">
        ...
        <li class="sub-list font-sm">
            <a href="{{route('meta.index')}}" class="text-white">
                <span><i class="fa-solid fa-circle-dot me-3"></i>{{$sidebar['metas']}}</span>
            </a>
        </li>
        @endcan
        @can('canonical-index')
        <li class="sub-list font-sm">
            <a href="{{route('canonical.index')}}" class="text-white">
                <span><i class="fa-solid fa-circle-dot me-3"></i>{{$sidebar['canonicals']}}</span>
            </a>
        </li>
        @endcan
        @can('opengraph-index')
        <li class="sub-list font-sm">
            <a href="{{route('opengraph.index')}}" class="text-white">
                <span><i class="fa-solid fa-circle-dot me-3"></i>{{$sidebar['opengraph']}}</span>
            </a>
        </li>
        @endcan
        @can('schema-index')
        <li class="sub-list font-sm">
            <a href="{{route('schema.index')}}" class="text-white">
                <span><i class="fa-solid fa-circle-dot me-3"></i>{{$sidebar['schema']}}</span>
            </a>
        </li>
        @endcan
    </ul>
