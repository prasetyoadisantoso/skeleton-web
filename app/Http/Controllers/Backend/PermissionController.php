...
class PermissionController extends Controller
{
    ...
    {
        $this->boot();
        return view('template.default.backend.permissions.home',  array_merge(
    ...
    {
        $this->boot();
        return view('template.default.backend.permissions.form', array_merge(
    ...
    public function edit($id)
    {
        ...
        return view('template.default.backend.permissions.form', array_merge($this->global_variable->PageType('edit'), [
            "permission"=> $permission,
        ]));
    }
